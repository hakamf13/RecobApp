...
import com.manpro.recobapp.databinding.FragmentVerifyAccountForgotBinding
...
class VerifyAccountForgotFragment : Fragment() {
    private var _binding: FragmentVerifyAccountForgotBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentVerifyAccountForgotBinding.inflate(
            inflater,
            container,
            false
        )
    ...
    private fun setListener() {
        ...
        binding.apply {
            ...
            backNav.setOnClickListener {
                parentFragmentManager.beginTransaction().remove(this@VerifyAccountForgotFragment).commitAllowingStateLoss()
            }
